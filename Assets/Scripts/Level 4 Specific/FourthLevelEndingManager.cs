...
public class FourthLevelEndingManager : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D other)
    {
        ...
        if (other.gameObject.CompareTag("Player") && Memories.goodMemories >= 1 || karma.karmaValue > 1.5) // if either evaluates to true...
        {
            // Load the next part of the good path.
            Destroy(player);
            SceneManager.LoadScene("GoodPath4");
        ...
        else if (other.gameObject.CompareTag("Player") && Memories.badMemories  >= 1 || karma.karmaValue <= -1.5) // if either evaluates to true...
        {
            ...
            Destroy(player);
            SceneManager.LoadScene("BadPath4");
            ...
            // if either evaluates to true...
        {
            ...
            Destroy(player);
            SceneManager.LoadScene("NeutralPath4");
        }
